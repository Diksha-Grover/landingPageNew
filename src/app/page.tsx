...
export default function Home() {
  ...
  return (
    <div className="h-screen bg-gradient-to-r from-lightBlue to-darkBlue text-white">
      <header>
        <nav
          aria-label="Global"
        ...
        >
          ...
          <PopoverGroup className="hidden lg:flex lg:gap-x-12">
            <Popover className="relative">
              <PopoverButton className="flex items-center gap-x-1 text-white font-semibold text-white">
                Product
                <ChevronDownIcon
                  aria-hidden="true"
              ...
              >
                <div className="p-4">
                  {products.map((item) => (
                    <div
                      key={item.name}
                      className="group relative flex items-center gap-x-6 rounded-lg p-4 text-white hover:bg-gray-50"
                    >
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                  {callsToAction.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2.5 p-3 text-white font-semibold text-white hover:bg-gray-100"
                    >
                      <item.icon
                        aria-hidden="true"
                        className="size-5 flex-none text-white"
            ...
            <a href="#" className="text-white font-semibold text-white">
              Features
            </a>
            <a href="#" className="text-white font-semibold text-white">
              Marketplace
